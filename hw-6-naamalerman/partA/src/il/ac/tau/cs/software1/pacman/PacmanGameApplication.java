...
import il.ac.tau.cs.software1.pacman.*;
...
public class PacmanGameApplication implements IGameLogic {
	...
	public void init() {
		...
		Renderer.getInstance().addTexture("bonus-cherry", "resources/textures/kenney_tiny-dungeon/Tiles/tile_0115.png"); //IMAGE FOR TASK1
		
		// Read scene
		//objects = PacmanSceneReader.readScene("resources/scenes/first.txt");
		//uncomment the second scene that includes the cherry bonus ( TASK1 )
		objects = PacmanSceneReader.readScene("resources/scenes/second.txt");
